...
E2014_cilm, E2014_gm, E2014_r0 = \
    pyshtools.shio.read_icgem_gfc(
        DATA_DIR / 'dV_ELL_Earth2014.gfc', lmax=SH_lmax_grid)
...
GOCO06s_coeffs.pad(lmax=SH_lmax_grid, copy=False)
...
LP_weights = \
    shtaper.taper_weights(l_start=180, l_stop=300,
                          l_max=SH_lmax_grid, taper="gentle")
...
cmap_tc_range = [np.quantile(E2014_grid_rad.data, 0.0001),
                 np.quantile(E2014_grid_rad.data, 0.9999)]
...
E2014_grid_rad_map.savefig(FIG_DIR / 'E2014_300_rad.png', dpi=FigDPI)
